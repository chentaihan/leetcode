...
func topKFrequentv1(words []string, k int) []string {
...
func TesttopKFrequent() {
	...
	for _, test := range tests {
		res := topKFrequent(test.words, test.k)
		fmt.Println(common.StringEqual(res, test.res))
	}
}
